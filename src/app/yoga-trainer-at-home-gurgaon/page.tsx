...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://www.satvikyog.co.in/yoga-trainer-at-home-gurgaon",
  },
...
export default function YogaTrainerAtHomeGurgaonPage() {
  return (
    <main>
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-text-light leading-relaxed mb-6">
            Practising yoga at home with proper guidance can help you build a
            consistent routine while learning yoga postures, breathing
            techniques and mindful movement correctly. Satvik Yoga focuses on
            creating sessions according to your experience, comfort level and
            wellness goals.
          </p>

          <p className="text-text-light leading-relaxed mb-8">
            Whether you are new to yoga or already have experience, a personal
            yoga trainer can help you understand posture, alignment, breathing
            and movement at your own pace. Home sessions can also be convenient
            for people with busy schedules who want to include wellness in
          ...
          <p className="text-text-light leading-relaxed mb-6">
            Satvik Yoga can help you explore different yoga and wellness
            practices based on your individual needs and goals.
          </p>

          <ul className="space-y-3 text-text-light mb-10">
            <li>• Hatha Yoga at Home</li>
            <li>• Ashtanga Yoga at Home</li>
          ...
          <p className="text-text-light leading-relaxed mb-6">
            Home yoga sessions offer the convenience of practising without
            travelling to a studio. Personal guidance can also make it easier
            to learn correct techniques and develop a regular practice.
            Depending on your routine and goals, yoga may support flexibility,
            strength, mobility, posture, relaxation and body awareness.
          </p>

          <p className="text-text-light leading-relaxed mb-8">
            A personalized approach can be particularly useful when you want
            to learn at a comfortable pace. Instead of following a general
            routine, sessions can focus on the areas of yoga that are most
          ...
          <p className="text-text-light leading-relaxed mb-6">
            ...
            for people who want to gradually develop confidence and consistency
          ...
          <p className="text-text-light leading-relaxed mb-6">
            ...
            personalized instruction, you can work towards building a yoga
          ...
          <p className="text-text-light leading-relaxed mb-6">
            Satvik Yoga combines traditional yoga practices with a practical
            approach for modern lifestyles. Our sessions focus on mindful
            movement, breathing awareness, flexibility, strength, relaxation
            and overall well-being.
          </p>

          <p className="text-text-light leading-relaxed mb-8">
            Whether you are searching for a yoga teacher at home in Gurgaon,
            personal yoga classes or beginner-friendly guidance, Satvik Yoga
